...
namespace ServerPMS
{
    public partial class MainForm : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            pnlNavButtons.Location = new Point(this.Size.Width / 2 - pnlNavButtons.Size.Width / 2, pnlNavButtons.Location.Y);

            pnl_uctodaymenu.Controls.Add(Program.uctm);

            pnl_uctoppanel.Controls.Add(Program.uctppnl);
        ...
        {
            Program.uctm.Filler_txtRPToday("Сейчас: " + DateTime.Now);
        }
        ...
        {
            Program.uctm.Filler_txt1DayIncoming("Заезды: " + input);
            //txt1DayIncoming.Text = "Заезды: " + input;
        }

        public void Set_1DayOutcoming(int input)
        {
            Program.uctm.Filler_txt1DayOutcoming("Выезды: " + input);
            //txt1DayOutcoming.Text = "Выезды: " + input;
        }

        public void Set_1DayLiving(int input)
        {
            Program.uctm.Filler_txt1DayLiving("Проживание: " + input);
        ...
        public void Set_1DayBirthdays(int input)
        {
            ...
            Program.uctm.Filler_txt1DayBirthdays("Дни рождения: " + input);
            //txt1DayLiving.Text = "Проживание: " + input;
        }

        public void Set_1DayTotalRooms(int input)
        {
            Program.uctm.Filler_txt1DayTotalRooms("Всего номеров: " + input);
        }

        public void Set_1DayTotalPlaces(string input)
        {
            Program.uctm.Filler_txt1DayTotalPlaces("Всего мест: " + input);
        }

        public void Set_1DayAvaliableRooms(int input)
        {
            Program.uctm.Filler_txt1DayAvaliableRooms("Свободно номеров: " + input);
        }

        public void Set_1DayOccupatedRooms(int input)
        {
            Program.uctm.Filler_txt1DayOccupatedRooms("Занято номеров: " + input);
        }

        public void Set_1DayOccupation(int input)
        {
            Program.uctm.Filler_txt1DayOccupation("Загрузка: " + input + "%");
        }
        ...
        private void uc_loader_DoWork(object sender, DoWorkEventArgs e)
        {
